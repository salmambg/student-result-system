package com.example.studentresultsystem.utils;
...
public class Constants {
    ...
    public static final String STUDENT_FOUND = "Student  found successfully!";
    ...
    public static final String  SEMESTER_UPDATED = "Semester updated successfully!";
    public static final String  SEMESTER_DELETED = "Semester deleted successfully!";
    ...
    public static final String STUDENT_RESULT_FOUND = "Result found successfully";
